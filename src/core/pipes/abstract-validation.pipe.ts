import { ArgumentMetadata, Injectable, ValidationPipe, ValidationPipeOptions, Type, BadRequestException, ValidationError } from '@nestjs/common';
            ...
            exceptionFactory: (errors: ValidationError[]) => {
                const formattedErrors = errors.map(error => {
                    ...
                    return {
                        ...
                        message: constraints ? constraints[firstConstraintKey] : 'Validation failed',
